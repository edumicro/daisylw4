# Guía del Componente Divider

## Nombre y Descripción

**Componente:** `daisylw4.layout.divider`
...
```blade
<livewire:daisylw4.layout.divider />
```
...
- `{{ trim('w-full ' . $containerClass) }}`
- `{{ trim('divider ' . ($vertical ? 'divider-vertical ' : '') . $class) }}`
- `h-4 w-4`
- `h-4 w-4`
