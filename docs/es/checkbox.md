# Guía del Componente Checkbox

## Nombre y Descripción

**Componente:** `daisylw4.form.checkbox`
...
```blade
<livewire:daisylw4.form.checkbox />
```
...
| `checked` | `bool` | `false` | Propiedad pública `checked` del componente. |
